...
import br.com.erudio.exception.MyFileSNotFoundException;
	...
	public Resource loadFileAsResource(String fileName) {
		try {
			...
			if(resource.exists()) {
				...
				throw new MyFileSNotFoundException("File not Found " + fileName);
			}
			
		} catch (Exception e) {
			throw new MyFileSNotFoundException("File not Found " + fileName ,e);
		}
	}
}
